...
- **裁定未完成就開工**：T3 依 AUT-Q1、DOM-Q2；T4 依 AUT-Q2、DOM-Q3；T6 依 AUT-Q4；T8 依 AUT-Q5。不要先用建議值實作再等裁定；建議值寫在規格裡，是給負責人選的，不是預設。
